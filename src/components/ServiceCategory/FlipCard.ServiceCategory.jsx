function FlipCardServiceCategory({ title, description, image }) {
  return (
    <div className="relative mx-5 flex h-60 md:mx-28 lg:mx-52">
      <div className="bottom-0 ml-10 mt-10 flex flex-row-reverse bg-cyan-100">
        <div className="mt-1 flex flex-col gap-y-2 self-center pr-2 md:pr-4 lg:gap-y-4 lg:pr-7">
          <h1 className="text-right text-3xl font-medium lg:text-4xl">
            {title}
          </h1>
