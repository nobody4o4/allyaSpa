...
function BookAppointment() {
  ...
  return (
    ...
    <div className="relative mx-auto w-full bg-white p-8 pt-28">
      ...
      >
        {({ isSubmitting }) => (
          <Form className="grid min-h-screen grid-cols-10 gap-y-10">
            <div className="col-span-full px-4 py-6 sm:py-6 lg:col-span-6 lg:py-12">
              <div className="mx-auto w-full max-w-lg space-y-4">
                <h1 className="relative mb-10 text-2xl font-medium text-gray-700 sm:text-3xl">
                  Book Appointment
            ...
            <div className="relative col-span-full flex flex-col py-6 pl-8 pr-4 sm:py-6 lg:col-span-4 lg:py-12">
              <h1 className="z-10 pb-8 text-2xl font-medium text-gray-700 sm:text-3xl">
                Services
                <span className="mt-2 block h-1 w-10 bg-teal-600 sm:w-20"></span>
              </h1>
              <div>
